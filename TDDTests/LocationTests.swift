...
class LocationTests: XCTestCase {
    ...
    func testInit_ShouldSetNameAndCoordinate(){
        ...
        XCTAssertEqual(location.coordinate?.latitude, testCoordinate.latitude, "Initializer should set lattitude")
    ...
    func performNotEqualTestWithLocationProperties(firstName: String, secondName: String, firstLongLat: (Double, Double)?, secondLongLat: (Double, Double)? , line : Int = #line){
